      ...
      <ul id="lst">
        <li>
          ...
          <p class="incHead">Коментарии</p>
           ...
           <?php
            mysql_select_db($server_db) or die (mysql_error());
            $result = mysql_query("SELECT id,name,content,replies FROM forum_threads ORDER BY date DESC LIMIT $start,$size");
            ...
            <p class="edit"><a href="edittems.php?id='.$new['id'].'"><img src="images/editIco.png" alt="" /></a> <a href="deletetems.php?id='.$new['id'].'"><img src="images/deletIco.png" alt="" /></a></p>
