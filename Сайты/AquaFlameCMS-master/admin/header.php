...
<h1><img src="../wow/static/images/logos/wof-logo.png" height="21px" width="260px"/><br />
		...
		<li><span rel="tooltip" title="<strong style='color:#00B6FF'><?php echo $admin['infoRate']; ?></strong>" style="color:#ff9200;font-weight:bold;font-size:14px;"><a class="ico3" href='view_info_rate.php'></a></span></li>
