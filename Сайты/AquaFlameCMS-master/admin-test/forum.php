...
<head>
  <meta charset="utf-8">
  <title><?php echo $website['title']; ?> - <?php echo $admin['AP']; ?> - <?php echo $admin['editForum']; ?></title>
...
<body>
  ...
  <div id="content" class="dashboard-page">
    <div id="inputs" class="box g8">
        <h2 class="box-ttl"><?php echo $admin['Forum']; ?></h2>
        <p>&nbsp;</p>
        <div id="page-content">
          <div class="box-body form" id="inputs">
            <form action="" enctype="multipart/form-data" method="post">
              ...
              <button type="submit" class="btn-m green" name="send"><?php echo $admin['SubForum']; ?></button>
      ...
      <div id="inputs" class="box g8">
        <h2 class="box-ttl"><?php echo $admin['ForumCat']; ?></h2>
        <p>&nbsp;</p>
          <div class="box-body form" id="inputs">
            <form action="" enctype="multipart/form-data" method="post">
              <p>&nbsp;</p>
    ...
    <div class="box-body form">
              ...
              <textarea type="text" name="description_form" class="g12" required="required" ></textarea>
              <div style="float: right; padding-right: 10px;">
              <button type="submit" class="btn-m green" name="send"><?php echo $admin['SubCatFor']; ?></button>
              <button align="right" type="reset" class="btn-m" class="ui-cancel "><?php echo $admin['Cancel']; ?></button>
            </div>
            </form>
          </div>
        ...
        <div class="box-body no-pad datatable-cont">
          <div id="example_wrapper" class="dataTables_wrapper" role="grid"><div id="example_length" class="dataTables_length">Show <div class="drop select"><select size="1" name="example_length" aria-controls="example" class="transformed" style="display: none;"><option value="5" selected="selected">5</option><option value="10">10</option><option value="25">25</option></select><ul><li class="sel">5</li><li class="">10</li><li>25</li></ul><span class="opt-sel" data-default-val="5">5</span><span class="arrow">&amp;</span></div> entries</div><div class="dataTables_filter" id="example_filter"><label>Search: <input type="text" aria-controls="example"></label></div><table class="display table dataTable" id="example" aria-describedby="example_info">
            <thead>
              ...
              <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 0px;"><font color="green"><?php echo $admin['Image']; ?></font></th>
              <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Desc']; ?></font></th>
              <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Categ']; ?></font></th>
              <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['comments']; ?></font></th>
  ...
  <div class="box g8">
        <h2 class="box-ttl"><?php echo $admin['ForumThreads']; ?></h2>
        <div class="box-body no-pad datatable-cont">
          <div id="example_wrapper" class="dataTables_wrapper" role="grid"><div id="example_length" class="dataTables_length">Show <div class="drop select"><select size="1" name="example_length" aria-controls="example" class="transformed" style="display: none;"><option value="5" selected="selected">5</option><option value="10">10</option><option value="25">25</option></select><ul><li class="sel">5</li><li class="">10</li><li>25</li></ul><span class="opt-sel" data-default-val="5">5</span><span class="arrow">&amp;</span></div> entries</div><div class="dataTables_filter" id="example_filter"><label>Search: <input type="text" aria-controls="example"></label></div><table class="display table dataTable" id="example" aria-describedby="example_info">
            <thead>
              <tr role="row">
        ...
        <div class="box-body no-pad datatable-cont">
          <div id="example_wrapper" class="dataTables_wrapper" role="grid"><div id="example_length" class="dataTables_length">Show <div class="drop select"><select size="1" name="example_length" aria-controls="example" class="transformed" style="display: none;"><option value="5" selected="selected">5</option><option value="10">10</option><option value="25">25</option></select><ul><li class="sel">5</li><li class="">10</li><li>25</li></ul><span class="opt-sel" data-default-val="5">5</span><span class="arrow">&amp;</span></div> entries</div><div class="dataTables_filter" id="example_filter"><label>Search: <input type="text" aria-controls="example"></label></div><table class="display table dataTable" id="example" aria-describedby="example_info">
            <thead>
              <tr role="row">
              <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 0px;"><font color="green"><?php echo $admin['Title']; ?></font></th>
              <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Number']; ?></font></th>
              <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Type']; ?></font></th>
              <th class="center sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Edit']; ?></font></th>
              <th class="center sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 0px;"><font color="green"><?php echo $admin['Del']; ?></font></th>
              </tr>
            </thead>
