...
<link rel="shortcut icon" href="<?php echo $website['root'];?>wow/static/local-common/images/favicons/index.ico" type="image/x-icon"/>
...
<div class="content-bot">
		...
		if($error == 1){
			...
			echo '</div>';
			if($posts['type'] == 1){
        echo '<meta http-equiv="refresh" content="0;url='.$website['root'].'forum/category/?f='.$thread['forumid'].'"';
      } else{
        echo '<meta http-equiv="refresh" content="2;url='.$website['root'].'forum/category/view-topic/?t='.$thread['id'].'"';
      }
		}
