...
//]]>
  ...
  include("functions/search/support.php");
  ?>
  	<div id="content">
      	...
      	<div class="content-bot">
        	<div class="search">
          	...
          	<div class="search-right">
            	<div class="search-header">
              	<form action="<?php echo 'search_s.php?search='.$term; ?>" method="get" class="search-form">
              	<div>
	...
	<!-- Here goes the pagination code. -->
              <div class="data-options ">
              	<div class="option">
                	...
                	<?php
                	if (!$error){
                  pagination($page,$num_pages,$term,'search_s.php',$ChatB['ChatB5'],$search['prev']);}
                  ?>
                	</ul>
               	</div>
              	<?php 
                if (!$error){
                echo $search['Show'].'<strong class="results-start"> '.($start+1).' </strong>-<strong class="results-end"> '.($start+$num_result).'</strong> '.$search['Of'].' <strong class="results-total"> '.($num_guild).' </strong>'.$search['Results']; }?>
	...
	<!-- And here it ends. -->
              ...
              <div class="table ">
                <table>
                    ...
                    <th><a href="" class="sort-link" ><span class="arrow">'.$search['message'].'</span></a></th>
                    <th class=" last-child"><a href="" class="sort-link" ><span class="arrow">'.$search['closedBy'].'</span></a></th>
                    <th width="6%"><a href="" class="sort-link" ><span class="arrow">'.$search['comment'].'</span></a></th>
                  </tr>
                </thead>
	             ...
	             if ($num_guild>0) {
	                 ...
	                 while ($row = mysql_fetch_array($result)){
                      ...
                      <tr class="row1">
                        ...
                        <td>'.$name_realm1['message'].'</td>
                        <td align="center">-</td>
                        <td class="align-center">'.$row["comment"].'</td>
                      </tr>';
                      }
                  echo '</tbody>';
                }
