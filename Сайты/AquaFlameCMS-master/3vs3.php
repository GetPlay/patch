...
<li class="last"><a href="3vs3.php" rel="np">Top 3vs3</a></li>
</ol>
</div>
...
$sql = mysql_query("SELECT name, rating, seasonGames, seasonWins FROM arena_team WHERE type = '3' ORDER BY rating DESC LIMIT 10") or die(mysql_error());
$i='1';
