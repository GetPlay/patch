...
//]]>
  ...
  include("functions/search/guild.php");
  ?>
  	<div id="content">
	...
	<!-- Here goes the pagination code. -->
              <div class="data-options ">
              	<div class="option">
                	...
                	<?php
                	if (!$error){
                  pagination($page,$num_pages,$term,'search_g.php',$ChatB['ChatB5'],$search['prev']);}
                  ?>
                	</ul>
               	</div>
              	<?php 
	...
	<!-- Here start the list of characters. -->';     //Echo first row of table
	             if ($num_guild>0) {
	                 ...
	                 while ($row = mysql_fetch_array($result)){
	                   echo'
                      <tr class="row1">
                        <td><strong><a href="guild.php?guildid='.$row['guildid'].'">'.$row["name"].'</a></strong></a></td>
