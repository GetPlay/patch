...
<li class="last children"><a href="advanced.php?name=<?php echo $character->getObjectInfo()->name;?>" rel="np"><?php echo $character->getObjectInfo()->name;?> @ <?php echo $realm['name'] ?>
</a>
</li>
</ol>
</div>
<div class="content-bot">
  ...
  <?php
    ...
    mysql_select_db($server_cdb,$connection_setup)or die(mysql_error());   //Gets title, have to make website title table
