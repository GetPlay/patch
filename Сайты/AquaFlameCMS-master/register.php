...
<?php
          ...
          function valid_email($email) {         //Small function to validate the email
              ...
              $question= $_POST['question1'];
                ...
                die("<p align='center'>".$Reg['Reg6']."<br><br>".$Reg['Reg9']."<br><br>".$Reg['Reg12']."<br><br>".$Reg['Reg13']."</p><p align='center'><a href='register.php'><button class='ui-button button1' type='submit' value='back' tabindex='1'><span><span>".$Reg['Reg38']."</span></span></button></a></p>");
              }
              ...
              $ip = getenv("REMOTE_ADDR");
                ...
                if ($accinfo == 0)
                {
                    ...
                    $register_cms = mysql_query("INSERT INTO users (id,class,firstName,lastName,registerIp,quest1,ans1) VALUES ('".mysql_real_escape_string($accountinfo['id'])."','0','".$firstName."','".$lastName."','".$ip."','".$question."',UPPER('".$answer."'))");
                    ...
                    if ($register_logon == true && $register_cms == true)
                    {
                        ...
                        echo'<a href="register.php"><button class="ui-button button1"  id="back" tabindex="1" /><span><span>'.$Reg['Reg38'].'</span></span></button></a></div>'; 
                    }
                }
              }
              ?>
...
<span class="label-text">
<?php echo $re['re34']; ?><?php echo $website['title']; ?>
<span class="input-required">*</span>
</span>
</label>
</span>
