...
<body class="bgc">
    ...
    <div id="content">
      ...
      <table>
        <thead>
        <tr>  
          <th class="edit"><strong>Редактировать</strong></th>
          <th></th>   
          <th class="title"><strong>Имя</strong></th>
          <th class="desc"><strong>Описание</strong></th>
          <th class="inc"><strong>Тем в форуме</strong></th>
          <th class="inc"><strong>Активен/закрыт</strong></th>
        </tr>
        </thead>
        <tbody>
      <?php
