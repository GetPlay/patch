    ...
    <div id="content">
        ...
        <form method="post" action="#" class="styleForm">
            ...
            <label>
              ...
              <p>Input field<br />
            <input name="Enter Title" type="text" value="Enter Title" class="reg" onfocus="if(this.value=='Enter Title')this.value=''" onblur="if(this.value=='')this.value='Enter Title'" />
          </p>
              <p>Input field<br />
            <input name="Enter Title" type="text" value="Enter Title" class="med" onfocus="if(this.value=='Enter Title')this.value=''" onblur="if(this.value=='')this.value='Enter Title'" />
              ...
              <p>Input field<br />
            <input name="Enter Title" type="text" value="Enter Title" class="large" onfocus="if(this.value=='Enter Title')this.value=''" onblur="if(this.value=='')this.value='Enter Title'" />
          </p>
              <p>Browse<br />
